...
const competitions = [
  ...
  // ═══════════════════════════════════════════════════════════════
  {
    ...
    setupTimeSeconds: 30,
    scoringCriteria: [
      { key: 'retry_count', label: 'จำนวนครั้งที่ Retry', type: 'number', pointsPerUnit: 0 },
      { key: 'checkpoint_red',    label: 'Checkpoint สีแดง',   type: 'number', pointsPerUnit: 10 },
      { key: 'checkpoint_yellow', label: 'Checkpoint สีเหลือง', type: 'number', pointsPerUnit: 10 },
      { key: 'checkpoint_blue',   label: 'Checkpoint สีน้ำเงิน', type: 'number', pointsPerUnit: 10 },
      { key: 'checkpoint_green',  label: 'Checkpoint สีเขียว',  type: 'number', pointsPerUnit: 10 },
      { key: 'bag_red',    label: 'ถุงยังชีพสีแดงวางถูก',   type: 'number', pointsPerUnit: 10 },
      { key: 'bag_yellow', label: 'ถุงยังชีพสีเหลืองวางถูก', type: 'number', pointsPerUnit: 10 },
      { key: 'bag_blue',   label: 'ถุงยังชีพสีน้ำเงินวางถูก', type: 'number', pointsPerUnit: 10 },
      { key: 'bag_green',  label: 'ถุงยังชีพสีเขียววางถูก',  type: 'number', pointsPerUnit: 10 },
